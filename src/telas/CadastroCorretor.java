...
public class CadastroCorretor extends javax.swing.JFrame {
    ...
    if (txtNomeCorretor.getText().equals("")){
        ...
        Corretor corretor = new Corretor(0, nomeCorretor_, rgCorretor_, cpfCorretor_, dataNascimentoCorretor_, telefoneCorretor_, "Corretor", salarioCorretor_, senhaCorretor_, creciCorretor_);
